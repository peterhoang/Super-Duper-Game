...
namespace ParticleEngine
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        private Platformer.PlatformerGame game;
        ...
        public void AddParticles(Vector2 where)
        {
            ...
            int numParticles = 
                PlatformerGame.Random.Next(minNumParticles, maxNumParticles);
        ...
        /// <summary>
        /// overriden from DrawableGameComponent, Draw will use PlatformerGame's 
